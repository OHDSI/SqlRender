...
namespace ohdsi { // Put everything in a namespace
	namespace sqlRender { // Nested namespaces are very helpful
		...
		private:
			...
			static SpanVector findParentheses(const String& str);
			static ConditionVector linkIfThenElses(const String &str, SpanVector &spans);
			static String parseIfThenElse(const String& str);
			static bool evaluateCondition(const String& str);
			static bool evaluateBooleanCondition(const String& inStr);
			static bool evaluatePrimitiveCondition(const String& str);
			static bool precededByIn(const int start, const String& str);
