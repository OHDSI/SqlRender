...
`AVG`, `CAST`, `COUNT`, `COUNT_BIG`, `DATEADD`, `DATEDIFF`, `DATEFROMPARTS`, `DAY`, `EXP`, `FLOOR`, `GETDATE`, `ISNULL`, `LEFT`, `LEN`, `LOG`, `MAX`, `MIN`, `MONTH`, `RIGHT`, `ROUND`, `STDEV`, `SQRT`, `SUM`, `TO_CHAR`, and `YEAR`.
