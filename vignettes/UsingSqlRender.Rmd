...
A second limitation is that currently only these dialects are supported as targets: **Oracle**, **PostgreSQL**, **Microsoft PDW (Parallel Data Warehouse)**, **Impala**, **Netezza**, and **Amazon Redhift**.
...
The hint should be formatted as shown above, and directly precede the statement where the table is created. 
