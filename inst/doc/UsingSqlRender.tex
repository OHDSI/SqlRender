...
\KeywordTok{renderSql}\NormalTok{(sql, }\DataTypeTok{a =} \DecValTok{123}\NormalTok{)}\OperatorTok{$}\NormalTok{sql}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{renderSql}\NormalTok{(sql, }\DataTypeTok{x =} \StringTok{"my_table"}\NormalTok{, }\DataTypeTok{a =} \DecValTok{123}\NormalTok{)}\OperatorTok{$}\NormalTok{sql}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{renderSql}\NormalTok{(sql, }\DataTypeTok{a =} \KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{))}\OperatorTok{$}\NormalTok{sql}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{renderSql}\NormalTok{(sql)}\OperatorTok{$}\NormalTok{sql}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{renderSql}\NormalTok{(sql, }\DataTypeTok{a =} \DecValTok{2}\NormalTok{)}\OperatorTok{$}\NormalTok{sql}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{renderSql}\NormalTok{(sql, }\DataTypeTok{x =} \OtherTok{FALSE}\NormalTok{)}\OperatorTok{$}\NormalTok{sql}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{renderSql}\NormalTok{(sql, }\DataTypeTok{x =} \OtherTok{TRUE}\NormalTok{)}\OperatorTok{$}\NormalTok{sql}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{renderSql}\NormalTok{(sql, }\DataTypeTok{x =} \DecValTok{1}\NormalTok{)}\OperatorTok{$}\NormalTok{sql}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{renderSql}\NormalTok{(sql, }\DataTypeTok{x =} \DecValTok{2}\NormalTok{)}\OperatorTok{$}\NormalTok{sql}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{renderSql}\NormalTok{(sql, }\DataTypeTok{x =} \DecValTok{4}\NormalTok{, }\DataTypeTok{y =} \DecValTok{4}\NormalTok{)}\OperatorTok{$}\NormalTok{sql}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{renderSql}\NormalTok{(sql, }\DataTypeTok{x =} \DecValTok{3}\NormalTok{, }\DataTypeTok{y =} \DecValTok{4}\NormalTok{)}\OperatorTok{$}\NormalTok{sql}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{translateSql}\NormalTok{(sql, }\DataTypeTok{targetDialect =} \StringTok{"oracle"}\NormalTok{)}\OperatorTok{$}\NormalTok{sql}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{translateSql}\NormalTok{(sql, }\DataTypeTok{targetDialect =} \StringTok{"oracle"}\NormalTok{, }\DataTypeTok{oracleTempSchema =} \StringTok{"temp_schema"}\NormalTok{)}\OperatorTok{$}\NormalTok{sql}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    sql <-}\StringTok{ }\KeywordTok{renderSql}\NormalTok{(sql, }\DataTypeTok{databaseSchema =}\NormalTok{ databaseSchema, }\DataTypeTok{database =}\NormalTok{ database)}\OperatorTok{$}\NormalTok{sql}
\NormalTok{    sql <-}\StringTok{ }\KeywordTok{translateSql}\NormalTok{(sql, }\DataTypeTok{targetDialect =}\NormalTok{ dbms)}\OperatorTok{$}\NormalTok{sql}
...
\NormalTok{    renderedSql <-}\StringTok{ }\KeywordTok{loadRenderTranslateSql}\NormalTok{(}\StringTok{"test.txt"}\NormalTok{, }\DataTypeTok{packageName =} \StringTok{"myPackage"}\NormalTok{, }
        \DataTypeTok{dbms =}\NormalTok{ connectionDetails}\OperatorTok{$}\NormalTok{dbms, }\DataTypeTok{selected_value =}\NormalTok{ selectedValue)}
